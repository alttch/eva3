...
class SFA_API(GenericAPI):
    ...
    def run(self, k = None, i = None, args = None, priority = None,
        ...
        return eva.sfa.controller.lm_pool.run(macro = i,
                args = args,
                priority = priority,
                wait = wait,
                uuid = uuid)
    ...
    def append_controller(self, k = None, uri = None, key = None, group = None,
    ...
    def list_rule_props(self, k = None, i = None):
        ...
        if not apikey.check(k, allow = [ 'dm_rule_props' ]) and \
                not apikey.check(k, rule): return None
...
class SFA_HTTP_API(GenericHTTP_API, SFA_API):
    ...
    def state_all(self, k = None):
        ...
        for p in [ 'U', 'S', 'LV']:
            try:
                ...
                pass
        return sorted(sorted(result, key=lambda k: k['id']),
                key=lambda k: k['type'])
    ...
    def append_controller(self, k = None, u = None, a = None, g = None,
            m = None, s = None, t = None, save = None):
        cp_need_master(k)
...
def start():
    ...
    cherrypy.tree.mount(SFA_HTTP_Root(), '/', config = {
            '/': {
    ...
    cherrypy.tree.mount(object(),'/ui',config =
        {
            '/': {
