...
class GenericAPI(object):
    ...
    def state_history(self, **kwargs):
        ...
        If option "w" (fill) is used, number digits after comma can be
        specified. E.g. 5T:3 will output values with 3 digits after comma.

        Additionally SI prefix can be specified and value will be converted to
        kilos, megas etc, e.g. 5T:k:3 - divide value by 1000 and output 3
        digits after comma. Valid prefixes are: k, M, G, T, P, E, Z, Y.
