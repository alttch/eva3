...
def update_config(cfg):
    ...
    try:
        rule_masks_enabled = cfg.get('plc/rule-masks-enabled', default=True)
    except:
        rule_masks_enabled = True
    logging.debug(f'plc.rule_masks_enabled = {rule_masks_enabled}')
    DM.masks_enabled = rule_masks_enabled
    try:
