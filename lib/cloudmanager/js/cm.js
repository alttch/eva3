...
function insertUnitsList(result) {
  ...
  $.each(result.data, function(k, v) {
    ...
    if(!$('#' + manage_controllers['current_item'] + '_' + unit_group)[0]) {
      ...
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('#' + manage_controllers['current_item'] + '_' + unit_group);
    }
...
function insertSensorsList(result) {
  ...
  $.each(result.data, function(k, v) {
    ...
    if(!$('#' + manage_controllers['current_item'] + '_' + sensor_group)[0]) {
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('<div />', {
        class: 'group_holder',
        id: manage_controllers['current_item'] + '_' + v.group
      ...
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('#' + manage_controllers['current_item'] + '_' + sensor_group);
    }
...
function insertOWFSList(result) {
  ...
  if($('#' + manage_controllers['current_item'] + '_list')[0]) {
    ig = $('#' + manage_controllers['current_item'] + '_list');
  } else {
    ig = $('<div />', {
      class: 'group_holder',
      id: manage_controllers['current_item'] + '_list'
    }).appendTo(ih);
    var ch = $('<div />', {
      class: 'group_ctrl_holder'
    }).appendTo(ih);
...
function insertLvarsList(result) {
  ...
  $.each(result.data, function(k, v) {
    ...
    if(!$('#' + manage_controllers['current_item'] + '_' + lvar_group)[0]) {
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('<div />', {
        class: 'group_holder',
        id: manage_controllers['current_item'] + '_' + v.group
      ...
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('#' + manage_controllers['current_item'] + '_' + lvar_group);
    }
...
function insertCyclesList(result) {
  ...
  $.each(result.data, function(k, v) {
    ...
    if(!$('#' + manage_controllers['current_item'] + '_' + cycle_group)[0]) {
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('<div />', {
        class: 'group_holder',
        id: manage_controllers['current_item'] + '_' + v.group
      ...
      ig[manage_controllers['current_item'] + '_' + v.group] = 
        $('#' + manage_controllers['current_item'] + '_' + cycle_group);
    }
