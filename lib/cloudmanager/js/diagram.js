    ...
    if (!mxClient.isBrowserSupported()) {
        ...
        try {
            ...
            for (var b in g_el_body) {
                ...
                if (x) {
                ...
                } else if (isKeyExist(t.body[b].params, 'args') || isKeyExist(t.body[b].params, 'IN')) {
                    var u = -1;
                    ...
                    for(let param in t.body[b].params) {
                        let inp = graph.insertVertex(g_el_body[b], null, block_name(param), 10, 90 + 40 * Object.keys(t.body[b].params).indexOf(param), 50, 30, 'body_child');
                        inp['type'] = 'in_block_out';
                        for (var i in g_el_body) {
