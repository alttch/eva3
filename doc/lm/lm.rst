...
process when the metrics are changed.
...
Additionally, you can use lm-rules console application for better control of the
:doc:`decision-making rules<decision_matrix>`.
...
well as :doc:`lm-cmd</cli>` **get_cvar** and **set_cvar** commands.
...
To manage LM server use ./sbin/lm-control script with the following options:
