...
usually has connected several or all available controllers. At least one MQTT
...
curretnyl used by SFA, this feature is reserved for the future EVA releases.
...
The configurations of the connected controllers are stored in the folder
...
.. note::
    ...
    Macros from **system** group and it's subgroups are not loaded to SFA
